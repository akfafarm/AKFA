...
contract KAFAChef {
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        uint256 stakedSupply = KAFA.balanceOf(address(this));
    ...
    function updatePool() public {
        ...
        uint256 KAFASupply = KAFA.balanceOf(address(this));
        if (KAFASupply == 0) {
        ...
        poolInfo.accRewardPerShare = poolInfo.accRewardPerShare.add(tokenReward.mul(1e12).div(KAFASupply));
        poolInfo.lastRewardBlock = block.number;
    }
    ...
    function deposit(uint256 _amount) public {
        ...
        updatePool();
        KAFA.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function withdraw(uint256 _amount) public {
        ...
        updatePool();
        KAFA.safeTransfer(address(msg.sender), _amount);
    ...
    function emergencyWithdraw() public {
        UserInfo storage user = userInfo[msg.sender];
        KAFA.safeTransfer(address(msg.sender), user.amount);
